...
namespace WpfApp
{
    public class MouseManager
    {
        ...
        /// <param name="xHotSpot">焦点在图片中的 X轴 座标(相对于左上角)</param>
        /// <param name="yHotSpot">焦点在图片中的 Y轴 座标(相对于左上角)</param>
        ...
        protected static Cursor InternalCreateCursor(Bitmap bitmap, uint xHotSpot, uint yHotSpot)
        {
            ...
            iconInfo.xHotspot = xHotSpot;//焦点x轴座标
            iconInfo.yHotspot = yHotSpot;//焦点y轴座标
